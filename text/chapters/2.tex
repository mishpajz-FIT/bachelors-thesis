...
Three.js was selected from a range of frameworks, including Babylon.js~\cite{BabylonJs} and PixiJS~\cite{PixiJS}, that are designed to streamline the process of developing in \noborderacrshort{webgl}. This decision was made after considering several important factors.
