...
The introduction of modern technologies such as \noborderacrshort{webgl} or \noborderacrfull{ar} has expanded the potential of online configurators. These advances enable these toolkits to become more powerful and visually illustrative tools that provide a higher level of interactivity and realism than what was previously accessible.~\cite{Cozzi2015}
