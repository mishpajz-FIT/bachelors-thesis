...
\todo{Update images, model composition snippets, expand the phone size in ContactInfoSchema, add more info about i18n and router initialization, add sort index to components}